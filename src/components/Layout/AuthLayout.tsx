          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="bg-blue-800 bg-opacity-30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">{t('common:feature_management')}</h3>
                <p className="text-blue-100">{t('common:feature_management_desc')}</p>
              </div>
              <div className="bg-blue-800 bg-opacity-30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">{t('common:feature_realtime')}</h3>
                <p className="text-blue-100">{t('common:feature_realtime_desc')}</p>
              </div>
              <div className="bg-blue-800 bg-opacity-30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">{t('common:feature_multilingual')}</h3>
                <p className="text-blue-100">{t('common:feature_multilingual_desc')}</p>
              </div>
              <div className="bg-blue-800 bg-opacity-30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2">{t('common:feature_offline')}</h3>
                <p className="text-blue-100">{t('common:feature_offline_desc')}</p>
              </div>
            </div>
          </motion.div>
        </div>
